...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() | pages-login-login-module */[__webpack_require__.e("default~pages-chat-chat-module~pages-forgot-password-forgot-password-module~pages-login-login-module~94a5a559"), __webpack_require__.e("pages-login-login-module")]).then(__webpack_require__.bind(null, /*! ./pages/login/login.module */ "./src/app/pages/login/login.module.ts")).then(m => m.LoginPageModule),
    },
    Object.assign({ path: 'chat', loadChildren: () => Promise.all(/*! import() | pages-chat-chat-module */[__webpack_require__.e("default~pages-chat-chat-module~pages-forgot-password-forgot-password-module~pages-login-login-module~94a5a559"), __webpack_require__.e("pages-chat-chat-module")]).then(__webpack_require__.bind(null, /*! ./pages/chat/chat.module */ "./src/app/pages/chat/chat.module.ts")).then(m => m.ChatPageModule) }, Object(_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_3__["canActivate"])(redirectUnauthorizedToLogin)),
    {
        path: 'register',
        loadChildren: () => Promise.all(/*! import() | pages-register-register-module */[__webpack_require__.e("default~pages-chat-chat-module~pages-forgot-password-forgot-password-module~pages-login-login-module~94a5a559"), __webpack_require__.e("pages-register-register-module")]).then(__webpack_require__.bind(null, /*! ./pages/register/register.module */ "./src/app/pages/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'verification-email',
        loadChildren: () => Promise.all(/*! import() | pages-send-email-send-email-module */[__webpack_require__.e("default~pages-chat-chat-module~pages-forgot-password-forgot-password-module~pages-login-login-module~94a5a559"), __webpack_require__.e("pages-send-email-send-email-module")]).then(__webpack_require__.bind(null, /*! ./pages/send-email/send-email.module */ "./src/app/pages/send-email/send-email.module.ts")).then(m => m.SendEmailPageModule),
    },
    {
        path: 'forgot-password',
        loadChildren: () => Promise.all(/*! import() | pages-forgot-password-forgot-password-module */[__webpack_require__.e("default~pages-chat-chat-module~pages-forgot-password-forgot-password-module~pages-login-login-module~94a5a559"), __webpack_require__.e("pages-forgot-password-forgot-password-module")]).then(__webpack_require__.bind(null, /*! ./pages/forgot-password/forgot-password.module */ "./src/app/pages/forgot-password/forgot-password.module.ts")).then(m => m.ForgotPasswordPageModule)
    },
];
...
module.exports = __webpack_require__(/*! C:\Users\vicen\Documents\DAVID\DESARROLLO-MOVIL\prueba 1\PruebaAppMoviles\src\main.ts */"./src/main.ts");
